...
public class ResourcePriorityTask implements AnalyticsTask {
    private static final String TASK_NAME = "resource-priority";
    private final AnalysisClient analysisClient;

    public ResourcePriorityTask(AnalysisClient analysisClient) {
